...
import { getDisciplinasAnteriores, montarGrade } from "../../services/grade.service";
...
export function MateriasConcluidas() {
    ...
    useEffect(() => {
        async function fetchData() {
            const data = await getDisciplinasAnteriores(
                courseId,
                matrizId,
                semestre
            );
    ...
    return (
        <div className={styles.container}>
            <div className={styles.header}>
                ...
                <p className={styles.description}>Desmarque as matérias que você ainda NÃO cursou</p>
            </div>
